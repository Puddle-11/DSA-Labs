...
#pragma region Test - Palindrome Number
	static int Battery_PalindromeNumber();
...
#pragma region Test - Fill From File
	static int Battery_FillVectorFromFile();
	...
	static FailResult Fail_FillVectorFromFile_LastValueDuplicated();
...
#pragma region Test - Fill From Array
	static int Battery_FillVectorFromArray();
...
#pragma region Test - Clear
	static int Battery_VectorClear();
...
#pragma region Test - Sort Ascending
	static int Battery_VectorSortAscending();
...
#pragma region Test - Sort Descending
	static int Battery_VectorSortDescending();
...
#pragma region Test - Operator []
	static int Battery_ArrayBracketOperator();
...
#pragma region Test - Contains True
	static int Battery_ContainsTrue();

	static FailResult Fail_ContainsTrue_DoesNotUseConditionalStatement();
...
#pragma region Test - Contains False
	static int Battery_ContainsFalse();

	static FailResult Fail_ContainsFalse_DoesNotUseConditionalStatement();
...
#pragma region Test - Remove Palindromes
	static int Battery_MovePalindromes();
