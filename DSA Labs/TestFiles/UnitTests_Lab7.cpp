...
#define POINTS_BST_CTOR								1
#define POINTS_BST_NODE_CTOR						1
#define POINTS_BST_PUSH_EMPTY						3
#define POINTS_BST_PUSH_LEFT						6
#define POINTS_BST_PUSH_RIGHT						6
#define POINTS_BST_CLEAR							5
#define POINTS_BST_DTOR								5
#define POINTS_BST_CONTAINS_FOUND					3
#define POINTS_BST_CONTAINS_NOTFOUND				3
#define POINTS_BST_REMOVE_CASE0_ROOT				2
#define POINTS_BST_REMOVE_CASE0_LEFT				2
#define POINTS_BST_REMOVE_CASE0_RIGHT				2
#define POINTS_BST_REMOVE_CASE1_ROOT_LEFT			2
#define POINTS_BST_REMOVE_CASE1_ROOT_RIGHT			2
#define POINTS_BST_REMOVE_CASE1_LEFT_LEFT			2
#define POINTS_BST_REMOVE_CASE1_LEFT_RIGHT			2
#define POINTS_BST_REMOVE_CASE1_RIGHT_LEFT			2
#define POINTS_BST_REMOVE_CASE1_RIGHT_RIGHT			2
#define POINTS_BST_REMOVE_CASE2_CASE0				5
#define POINTS_BST_REMOVE_CASE2_CASE1				5
#define POINTS_BST_REMOVE_CASE0						1
#define POINTS_BST_REMOVE_CASE1						1
#define POINTS_BST_REMOVE_CASE2						1
#define POINTS_BST_REMOVE_NOT_FOUND					1
#define POINTS_BST_IN_ORDER_TRAVERSAL				10
#define POINTS_BST_ASSIGNMENT_OP					15
#define POINTS_BST_COPY_CTOR						10
...
void UnitTests_Lab7::FullBattery() {
...
#ifndef _GRADING
	results::Log("BST.log", { "BST.h" });
	// results::WriteResults("BST.h", "BST.results");
#endif

	int totalScore = 0;

#if BST_CTOR
	totalScore += Battery_BSTConstructor();
#endif
#if BST_NODE_CTOR
	totalScore += Battery_NodeConstructor();
#endif
#if BST_PUSH_EMPTY
	totalScore += Battery_PushToEmptyTree();
#endif
#if BST_PUSH_ROOT_LEFT
	totalScore += Battery_PushToRootLeft();
#endif
#if BST_PUSH_ROOT_RIGHT
	totalScore += Battery_PushToRootRight();
#endif
#if BST_PUSH_LEFT
	totalScore += Battery_PushToLeftNonRoot();
#endif
#if BST_PUSH_RIGHT
	totalScore += Battery_PushToRightNonRoot();
#endif
#if BST_CLEAR
	...
	totalScore += Battery_ContainsFound();
#endif
#if BST_CONTAINS_NOTFOUND
	totalScore += Battery_ContainsNotFound();
#endif
#if BST_REMOVE_CASE0_ROOT
	totalScore += Battery_RemoveCase0_Root();
#endif
#if BST_REMOVE_CASE0_LEFT
	totalScore += Battery_RemoveCase0_LeftChild();
#endif
#if BST_REMOVE_CASE0_RIGHT
	totalScore += Battery_RemoveCase0_RightChild();
#endif
#if BST_REMOVE_CASE1_ROOT_LEFT
	totalScore += Battery_RemoveCase1_RootWithLeftChild();
#endif
#if BST_REMOVE_CASE1_ROOT_RIGHT
	totalScore += Battery_RemoveCase1_RootWithRightChild();
#endif
#if BST_REMOVE_CASE1_LEFT_LEFT
	totalScore += Battery_RemoveCase1_LeftChildWithLeftChild();
#endif
#if BST_REMOVE_CASE1_LEFT_RIGHT
	totalScore += Battery_RemoveCase1_LeftChildWithRightChild();
#endif
#if BST_REMOVE_CASE1_RIGHT_LEFT
	totalScore += Battery_RemoveCase1_RightChildWithLeftChild();
#endif
#if BST_REMOVE_CASE1_RIGHT_RIGHT
	totalScore += Battery_RemoveCase1_RightChildWithRightChild();
#endif
#if BST_REMOVE_CASE2_CASE0
	totalScore += Battery_RemoveCase2_LeadsToCase0();
#endif
#if BST_REMOVE_CASE2_CASE1
	totalScore += Battery_RemoveCase2_LeadsToCase1();
#endif
#if BST_REMOVE_CASE0
	totalScore += Battery_Remove_Case0();
#endif
#if BST_REMOVE_CASE1
	totalScore += Battery_Remove_Case1();
#endif
#if BST_REMOVE_CASE2
	totalScore += Battery_Remove_Case2();
#endif
#if BST_REMOVE_NOT_FOUND
	totalScore += Battery_Remove_NotFound();
#endif
#if BST_IN_ORDER_TRAVERSAL
	totalScore += Battery_InOrder();
#endif
...
#if BST_CTOR
int UnitTests_Lab7::Battery_BSTConstructor() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing constructor", POINTS_BST_CTOR,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_CTOR, totalDeductions);
...
#if BST_NODE_CTOR
int UnitTests_Lab7::Battery_NodeConstructor() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing Node constructor", POINTS_BST_NODE_CTOR,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_NODE_CTOR, totalDeductions);
...
#if BST_COPY_CTOR
int UnitTests_Lab7::Battery_CopyConstructor() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing copy constructor", POINTS_BST_COPY_CTOR,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_COPY_CTOR, totalDeductions);
...
#if BST_ASSIGNMENT_OP
int UnitTests_Lab7::Battery_AssignmentOperator() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing assignment operator", POINTS_BST_ASSIGNMENT_OP,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_ASSIGNMENT_OP, totalDeductions);
...
FailResult UnitTests_Lab7::Fail_AssignmentOperator_NoSelfAssignmentCheck() {
	bool selfAssignmentFound = SearchFile("BST.h", "BST& operator=(const BST&", "void Clear(", "if(this != &_assign)") ||
							   SearchFile("BST.h", "BST& operator=(const BST&", "void Clear(", "if(this == &_assign)") || 
							   SearchFile("BST.h", "BST& operator=(const BST&", "void Clear(", "if(&_assign != this)") ||
							   SearchFile("BST.h", "BST& operator=(const BST&", "void Clear(", "if(&_assign == this)");
...
FailResult UnitTests_Lab7::Fail_AssignmentOperator_TooMuchMemoryAllocated() {
	...
	*assign = *original;
	size_t memoryDeltaEnd = inUse;
	size_t memoryDiff = memoryDeltaEnd - memoryDeltaStart;

	FailResult result;
	result.check = memoryDiff > 0;
	result.deduction = 5;
...
#if BST_CLEAR
int UnitTests_Lab7::Battery_Clear() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing Clear", POINTS_BST_CLEAR,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_CLEAR, totalDeductions);
...
#if BST_DTOR
int UnitTests_Lab7::Battery_Destructor() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing destructor", POINTS_BST_DTOR,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_DTOR, totalDeductions);
...
#if BST_PUSH_EMPTY
int UnitTests_Lab7::Battery_PushToEmptyTree() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing Push on empty tree", POINTS_BST_PUSH_EMPTY,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_PUSH_EMPTY, totalDeductions);
...
#if BST_PUSH_ROOT_LEFT
int UnitTests_Lab7::Battery_PushToRootLeft() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing Push left with only root", POINTS_BST_PUSH_ROOT_LEFT,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_PUSH_ROOT_LEFT, totalDeductions);
...
FailResult UnitTests_Lab7::Fail_PushToRootLeft_NewNodeParentIsNotRoot() {
	...
	FailResult result;
	result.check = bst.mRoot && bst.mRoot->left && bst.mRoot->left->parent != bst.mRoot;
...
#if BST_PUSH_ROOT_RIGHT
int UnitTests_Lab7::Battery_PushToRootRight() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing Push right with only root", POINTS_BST_PUSH_ROOT_RIGHT,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_PUSH_ROOT_RIGHT, totalDeductions);
...
#if BST_PUSH_LEFT
int UnitTests_Lab7::Battery_PushToLeftNonRoot() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing Push left on tree with many nodes",POINTS_BST_PUSH_LEFT,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_PUSH_LEFT, totalDeductions);
...
#if BST_PUSH_RIGHT
int UnitTests_Lab7::Battery_PushToRightNonRoot() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing Push right on tree with many nodes", POINTS_BST_PUSH_RIGHT,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_PUSH_RIGHT, totalDeductions);
...
#if BST_CONTAINS_FOUND
int UnitTests_Lab7::Battery_ContainsFound() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing Contains (found)", POINTS_BST_CONTAINS_FOUND,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_CONTAINS_FOUND, totalDeductions);
...
#if BST_CONTAINS_NOTFOUND
int UnitTests_Lab7::Battery_ContainsNotFound() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing Contains (not found)", POINTS_BST_CONTAINS_NOTFOUND,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_CONTAINS_NOTFOUND, totalDeductions);
...
#if BST_REMOVE_CASE0_ROOT
int UnitTests_Lab7::Battery_RemoveCase0_Root() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing RemoveCase0 (Root)", POINTS_BST_REMOVE_CASE0_ROOT,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_CASE0_ROOT, totalDeductions);
...
#if BST_REMOVE_CASE0_LEFT
int UnitTests_Lab7::Battery_RemoveCase0_LeftChild() {
	FailVector failVec;
	...
	failVec.push_back(Fail_RemoveCase0_LeftChild_RootIsChanged);
	...
	int totalDeductions = UnitTestBattery("Testing RemoveCase0 (Left Child)", POINTS_BST_REMOVE_CASE0_LEFT,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_CASE0_LEFT, totalDeductions);
...
FailResult UnitTests_Lab7::Fail_RemoveCase0_LeftChild_RootIsChanged() {
	BST* bst = GenerateTree();
	Node* parent = treeNodes[65];
	...
	FailResult result;
	result.check = bst->mRoot != treeNodes[50];
	result.deduction = 2;
	result.msg = "Root should not be changed";
...
#if BST_REMOVE_CASE0_RIGHT
int UnitTests_Lab7::Battery_RemoveCase0_RightChild() {
	FailVector failVec;
	...
	failVec.push_back(Fail_RemoveCase0_RightChild_RootIsChanged);
	...
	int totalDeductions = UnitTestBattery("Testing RemoveCase0 (Right Child)", POINTS_BST_REMOVE_CASE0_RIGHT,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_CASE0_RIGHT, totalDeductions);
...
FailResult UnitTests_Lab7::Fail_RemoveCase0_RightChild_RootIsChanged() {
	BST* bst = GenerateTree();
	Node* parent = treeNodes[10];
...
#if BST_REMOVE_CASE1_ROOT_LEFT
int UnitTests_Lab7::Battery_RemoveCase1_RootWithLeftChild() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing RemoveCase1 (Root with Left Child)", POINTS_BST_REMOVE_CASE1_ROOT_LEFT,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_CASE1_ROOT_LEFT, totalDeductions);
...
#if BST_REMOVE_CASE1_ROOT_RIGHT
int UnitTests_Lab7::Battery_RemoveCase1_RootWithRightChild() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing RemoveCase1 (Root with Right Child)", POINTS_BST_REMOVE_CASE1_ROOT_RIGHT,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_CASE1_ROOT_RIGHT, totalDeductions);
...
#if BST_REMOVE_CASE1_LEFT_LEFT
int UnitTests_Lab7::Battery_RemoveCase1_LeftChildWithLeftChild() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing RemoveCase1 (Left Child with Left Child)", POINTS_BST_REMOVE_CASE1_LEFT_LEFT,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_CASE1_LEFT_LEFT, totalDeductions);
...
#if BST_REMOVE_CASE1_LEFT_RIGHT
int UnitTests_Lab7::Battery_RemoveCase1_LeftChildWithRightChild() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing RemoveCase1 (Left Child with Right Child)", POINTS_BST_REMOVE_CASE1_LEFT_RIGHT,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_CASE1_LEFT_RIGHT, totalDeductions);
...
#if BST_REMOVE_CASE1_RIGHT_LEFT
int UnitTests_Lab7::Battery_RemoveCase1_RightChildWithLeftChild() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing RemoveCase1 (Right Child with Left Child)", POINTS_BST_REMOVE_CASE1_RIGHT_LEFT,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_CASE1_RIGHT_LEFT, totalDeductions);
...
#if BST_REMOVE_CASE1_RIGHT_RIGHT
int UnitTests_Lab7::Battery_RemoveCase1_RightChildWithRightChild() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing RemoveCase1 (Right Child with Right Child)", POINTS_BST_REMOVE_CASE1_RIGHT_RIGHT,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_CASE1_RIGHT_RIGHT, totalDeductions);
...
#if BST_REMOVE_CASE2_CASE0
int UnitTests_Lab7::Battery_RemoveCase2_LeadsToCase0() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing RemoveCase2 (Leads to Case 0)", POINTS_BST_REMOVE_CASE2_CASE0,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_CASE2_CASE0, totalDeductions);
...
#if BST_REMOVE_CASE2_CASE1
int UnitTests_Lab7::Battery_RemoveCase2_LeadsToCase1() {
	FailVector failVec;
	failVec.push_back(Fail_RemoveCase2_LeadsToCase1_IncorrectAmountOfMemoryAllocated);
	//failVec.push_back(Fail_RemoveCase2_LeadsToCase1_MemoryIsLeaked);		// Not sure if test is necessary or correct
	...
	int totalDeductions = UnitTestBattery("Testing RemoveCase2 (Leads to Case 1)", POINTS_BST_REMOVE_CASE2_CASE1,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_CASE2_CASE1, totalDeductions);
...
FailResult UnitTests_Lab7::Fail_RemoveCase2_LeadsToCase1_MemoryIsLeaked() {
	size_t memoryDeltaStart = inUse;
	...
	result.deduction = 5;
	result.msg = "Memory leak (likely due to nodes not being connected correctly";
...
#if BST_REMOVE_CASE0
int UnitTests_Lab7::Battery_Remove_Case0() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing Remove (Case 0)", POINTS_BST_REMOVE_CASE0,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_CASE0, totalDeductions);
...
#if BST_REMOVE_CASE1
int UnitTests_Lab7::Battery_Remove_Case1() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing Remove (Case 1)", POINTS_BST_REMOVE_CASE1,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_CASE1, totalDeductions);
...
#if BST_REMOVE_CASE2
int UnitTests_Lab7::Battery_Remove_Case2() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing Remove (Case 2)", POINTS_BST_REMOVE_CASE2,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_CASE2, totalDeductions);
...
#if BST_REMOVE_NOT_FOUND
int UnitTests_Lab7::Battery_Remove_NotFound() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing Remove (Not Found)", POINTS_BST_REMOVE_NOT_FOUND,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_REMOVE_NOT_FOUND, totalDeductions);
...
#if BST_IN_ORDER_TRAVERSAL
int UnitTests_Lab7::Battery_InOrder() {
	FailVector failVec;
	...
	int totalDeductions = UnitTestBattery("Testing InOrder", POINTS_BST_IN_ORDER_TRAVERSAL,failVec, passVec);
	int scoreForTest = CalculatePointsForTest(POINTS_BST_IN_ORDER_TRAVERSAL, totalDeductions);
